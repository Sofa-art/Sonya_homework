...
2. В отчете Allure вы увидите:
   - **Название теста**: `Тестирование калькулятора на операцию +`.
   - **Описание теста**: Описание, что тест проверяет корректность работы калькулятора.
   - **Шаги теста**:
     - Открытие браузера и страницы калькулятора.
     - Установка задержки {delay} секунд.
     - Нажатие кнопок 7, +, 8, =.
     - Получение результата.
     - Проверка и сравнение результата.
   - **Результат**: Успешное выполнение с указанием ожидаемого и фактического результата.

   - **Название теста**: `Тестирование магазина на различные функции`.
   ...
   - **Шаги теста**:
     ...
     - Получение и сравнение итоговой суммы.
   - **Результат**: Успешное выполнение с указанием ожидаемого и фактического результата.